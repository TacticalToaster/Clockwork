...
function Clockwork:PlayerCharacterInitialized(player)
	...
	player.cwAttrProgressTime = player.cwAttrProgressTime or 0;
...
function Clockwork:PlayerCharacterLoaded(player)
	...
	player.cwCharLoadedTime = player.cwCharLoadedTime or CurTime();
	player.cwCrouchedSpeed = player.cwCrouchedSpeed or self.config:Get("crouched_speed"):Get();
	player.cwClipTwoInfo = player.cwClipTwoInfo or {weapon = NULL, ammo = 0};
	player.cwClipOneInfo = player.cwClipOneInfo or {weapon = NULL, ammo = 0};
	player.cwInitialized = player.cwInitialized or true;
	...
	player.cwFirstSpawn = player.cwFirstSpawn or true;
	player.cwLightSpawn = player.cwLightSpawn or false;
	player.cwChangeClass = player.cwChangeClass or false;
	player.cwInfoTable = player.cwInfoTable or {};
	player.cwSpawnAmmo = player.cwSpawnAmmo or {};
	player.cwJumpPower = player.cwJumpPower or self.config:Get("jump_power"):Get();
	player.cwWalkSpeed = player.cwWalkSpeed or self.config:Get("walk_speed"):Get();
	player.cwRunSpeed = player.cwRunSpeed or self.config:Get("run_speed"):Get();
...
function Clockwork:OnClockworkReloaded()
	ErrorNoHalt("Clockwork has Auto Refreshed serverside!\n");
end;

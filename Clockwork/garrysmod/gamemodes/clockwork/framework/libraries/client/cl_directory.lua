...
-- Directory library causes 20 second freeze on refresh, and creation of over 99999 copies of the same page.
-- So, we don't need to refresh it.
-- P.S: Check and mate, Duck. You didn't know how to fix that.
if (!Clockwork.directory and !CWDirLib) then

...
-- We don't need to refresh chatbox either. It causes some weird shit if refreshed.
if (!Clockwork.chatBox) then
  Clockwork.chatBox = Clockwork.kernel:NewLibrary("ChatBox");
  	...
  	Clockwork.chatBox.icons = Clockwork.chatBox.icons or {};
  chat.ClockworkAddText = chat.ClockworkAddText or chat.AddText;
